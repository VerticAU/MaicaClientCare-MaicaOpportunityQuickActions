({
    ...
    getParams: function(component, event, helper) {
        ...
        return {
            ...
            searchMode: component.get('v.searchMode'),
    ...
    getRecordByValue: function(component, event, helper) {
        ...
        params.filter = (component.get('v.valueField') || 'Id') + ' = \'' + value + '\'';

        getRecordsAction.setBackground();
        getRecordsAction.setStorable();
    ...
    getRecordLabel: function(component, event, helper) {
        ...
        getRecordLabelAction.setBackground();
        getRecordLabelAction.setStorable();
    ...
    getLookupInputValue: function(component){
        var elem = component.find('lookupInput').getElement();
        return elem ? elem.value : '';
    },
    getRecordsBySearchTerm: function(component, event, helper) {
        var searchTerm = helper.getLookupInputValue(component);
        ...
        component.set('v.searchTimeout', setTimeout($A.getCallback(function() {
            ...
            params.searchTerm = helper.getLookupInputValue(component);
            ...
            getRecordsAction.setCallback(this, function(res) {
                if (res.getState() === 'SUCCESS') {
                    ...
                    if (returnValue.isSuccess && returnValue.results.searchTerm === helper.getLookupInputValue(component)) {
                        var returnedRecords = [];
    ...
    setRecords: function(component, event, helper, returnedRecords) {
        component.set('v.focusIndex', null);
        component.set('v.lastSearchTerm', helper.getLookupInputValue(component));
    ...
    openMenu: function(component, event, helper) {
        ...
        var allowNewRecords = component.get('v.allowNewRecords') === true;
        component.set('v.openMenu', !component.get('v.disabled') && (!$A.util.isEmpty(component.get('v.lastSearchTerm')) || showRecentRecords || allowNewRecords));
    },
    ...
    addNewRecord: function(component, event, helper) {
        ...
        if (overrideNewEvent) {
            addRecordEvent = component.getEvent('aura_Lookup_evt_addNewRecord');
        } else {
